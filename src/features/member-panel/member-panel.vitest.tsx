...
const state: AppState = {
  ...
  scales: [{ id: 's-1', ownerAdminId: 'u-admin', congregacao: 'SP AM', titulo: 'Culto', dataISO: '2026-06-01', assignments: [{ id: 'a-1', memberId: 'u-1', status: 'pendente' }], notes: '', playlistLink: '' }],
  songs: []
};
